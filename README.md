...
See: [silentemmanuel.com](https://silentemmanuel.com).
...
```bash
git clone git://github.com/mrsilentemmanuel/personal-site.git # replace [mrsilentemmanuel] with your github username if you fork first.
cd personal-site
